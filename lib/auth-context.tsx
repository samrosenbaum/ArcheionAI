...
export function useMockAuth() {
  ...
  return {
    user,
    loading: false,
    signIn: async () => ({ error: 'Mock auth - use real auth in production' }),
    signUp: async () => ({ error: 'Mock auth - use real auth in production' }),
    signOut: async () => {},
    signInWithProvider: async () => ({ error: 'Mock auth - use real auth in production' })
  }
}
